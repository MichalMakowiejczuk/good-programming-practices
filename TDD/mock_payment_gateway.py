from payment_gateway import PaymentGateway, TransactionResult, TransactionStatus, NetworkException, PaymentException, RefundException
...
class MockPaymentGateway(PaymentGateway):
    ...
    def charge(self, user_id: str, amount: float) -> TransactionResult:
        ...
        return TransactionResult(success=True, transaction_id=transaction_id, message="Payment successful")
    ...
    def refund(self, transaction_id: str) -> TransactionResult:
        ...
        return TransactionResult(success=True, transaction_id=transaction_id, message="Refund successful")
